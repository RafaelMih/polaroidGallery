!(function(t, e, i, n) {
  var a = e.document,
    ...
    p = "file:" == e.location.protocol ? "http:" : e.location.protocol,
    f = Math,
    g = function() {},
    m = function() {
      return !1;
    ...
    v = !(
      (e.screen.width > 1279 && 1 == e.devicePixelRatio) ||
      (e.screen.width > 1e3 && e.innerWidth < 0.9 * e.screen.width)
    ),
    y = (function() {
      var t = 3,
    ...
    k = function(e) {
      return t.inArray(e, x) > -1 ? i[e.toUpperCase()] : e;
    },
    C = {
      youtube: {
        reg: /https?:\/\/(?:[a-zA_Z]{2,3}.)?(?:youtube\.com\/watch\?)((?:[\w\d\-\_\=]+&amp;(?:amp;)?)*v(?:&lt;[A-Z]+&gt;)?=([0-9a-zA-Z\-\_]+))/i,
        embed: function() {
          return p + "//www.youtube.com/embed/" + this.id;
        },
        get_thumb: function(t) {
          return p + "//img.youtube.com/vi/" + this.id + "/default.jpg";
        },
        get_image: function(t) {
          return p + "//img.youtube.com/vi/" + this.id + "/hqdefault.jpg";
        }
      },
      vimeo: {
        reg: /https?:\/\/(?:www\.)?(vimeo\.com)\/(?:hd#)?([0-9]+)/i,
        embed: function() {
          return p + "//player.vimeo.com/video/" + this.id;
        },
        getUrl: function() {
    ...
    I = function(i, n) {
      for (var a = 0; a < C._inst.length; a++)
        if (C._inst[a].id === n && C._inst[a].type == i) return C._inst[a];
      (this.type = i), (this.id = n), (this.readys = []), C._inst.push(this);
      var o = this;
      t.extend(this, C[i]),
        (_videoThumbs = function(e) {
          (o.data = e),
            t.each(o.readys, function(t, e) {
              e(o.data);
            }),
            (o.readys = []);
        }),
        this.hasOwnProperty("getUrl")
          ? t.getJSON(this.getUrl(), _videoThumbs)
          : e.setTimeout(_videoThumbs, 400),
        (this.getMedia = function(t, e, i) {
          ...
          try {
            n.data ? a(n.data) : n.readys.push(a);
          } catch (t) {
            i();
          }
        });
    ...
    S = function(t) {
      var e;
      for (var i in C)
        if ((e = t && C[i].reg && t.match(C[i].reg)) && e.length)
        ...
        if (this.support) {
          var t = function() {
            if (A.instance) {
              ...
              (a.msFullscreenElement && null !== a.msFullscreenElement)
                ? t._enter(A.callback)
                : t._exit(A.callback);
            }
          };
          a.addEventListener("fullscreenchange", t, !1),
            a.addEventListener("MSFullscreenChange", t, !1),
            a.addEventListener("mozfullscreenchange", t, !1),
            a.addEventListener("webkitfullscreenchange", t, !1);
        }
      }
    },
    E = [],
      ...
      return {
        ...
        animate: (function() {
          var n,
            ...
            u = (function(t) {
              var i,
                n = "transition WebkitTransition MozTransition OTransition".split(
                  " "
                );
              if (e.opera) return !1;
              for (i = 0; n[i]; i++) if (void 0 !== t[n[i]]) return n[i];
              return !1;
            ...
            m = function(t) {
              f(t, "none", "transition"),
                i.WEBKIT &&
                  i.TOUCH &&
                  (f(t, "translate3d(0,0,0)", "transform"),
                  t.data("revert") &&
                    (t.css(t.data("revert")), t.data("revert", null)));
            };
          return function(a, v, y) {
            return (
              (y = t.extend({ duration: 400, complete: g, stop: !1 }, y)),
              (a = t(a)),
              y.duration
                ? u
                  ? (y.stop && (a.off(d), m(a)),
                    ...
                    t.each(v, function(t, e) {
                      (h = a.css(t)),
                        H.parseValue(h) != H.parseValue(e) && (n = !0),
                        a.css(t, h);
                    }),
                    n
                      ? ((o = []),
                        (r = y.easing in p ? p[y.easing] : p._default),
                        (s =
                          " " +
                          y.duration +
                          "ms cubic-bezier(" +
                  ...
                  : void a.animate(v, y)
                : (a.css(v), void y.complete.call(a[0]))
            );
          };
        })(),
        removeAlpha: function(t) {
          if ((t instanceof jQuery && (t = t[0]), y < 9 && t)) {
            var e = t.style,
              i = t.currentStyle,
              n = (i && i.filter) || e.filter || "";
            /alpha/.test(n) && (e.filter = n.replace(/alpha\([^)]*\)/i, ""));
          }
        },
        ...
        hide: function(e, i, n) {
          n = n || g;
          var a = t(e);
          (e = a[0]), a.data("opacity") || a.data("opacity", a.css("opacity"));
          var o = { opacity: 0 };
          if (i) {
            var r =
              y < 9 && e
                ...
                : n;
            H.animate(e, o, { duration: i, complete: r, stop: !0 });
          } else
            y < 9 && e
              ? (H.removeAlpha(e), (e.style.visibility = "hidden"))
              : a.css(o);
        },
        show: function(e, i, n) {
          n = n || g;
          ...
          var o = parseFloat(a.data("opacity")) || 1,
            r = { opacity: o };
          if (i) {
            y < 9 && (a.css("opacity", 0), (e.style.visibility = "visible"));
            var s =
              y < 9 && e
                ? function() {
                    1 == r.opacity && H.removeAlpha(e), n.call(e);
                  }
                : n;
            H.animate(e, r, { duration: i, complete: s, stop: !0 });
          } else
            y < 9 && 1 == r.opacity && e
              ? (H.removeAlpha(e), (e.style.visibility = "visible"))
              : a.css(r);
        },
        wait: function(n) {
          ...
          var a,
            ...
            l = function() {
              return (
                (o = H.timestamp()),
                (a = o - s),
                H.removeFromArray(i._waiters, r),
                n.until(a)
                  ? (n.success(), !1)
                  : "number" == typeof n.timeout && o >= s + n.timeout
                  ? (n.error(), !1)
                  : void i._waiters.push((r = e.setTimeout(l, 10)))
              );
            };
          i._waiters.push((r = e.setTimeout(l, 10)));
        },
        ...
        loadCSS: function(e, o, r) {
          ...
          if (
            (t("link[rel=stylesheet]").each(function() {
              if (new RegExp(e).test(this.href)) return (s = this), !1;
            }),
            "function" == typeof o && ((r = o), (o = n)),
            (r = r || g),
            s)
          )
            return r.call(s, s), s;
          if (((l = a.styleSheets.length), t("#" + o).length))
            t("#" + o).attr("href", e), l--;
          else {
            s = t("<link>")
    ...
    M = (function() {
      var e = function(e, i, n, a) {
        var o = this.getOptions("easing"),
          ...
          l = { left: 0 };
        n ? ((s.opacity = 0), (l.opacity = 1)) : (s.opacity = 1),
          t(e.next).css(s),
          H.animate(e.next, l, {
            duration: e.speed,
            complete: (function(t) {
      ...
      return {
        active: !1,
        init: function(t, e, i) {
          M.effects.hasOwnProperty(t) && M.effects[t].call(this, e, i);
        },
        effects: {
          fade: function(e, i) {
          ...
          fadeslide: function(t, i) {
            e.apply(this, H.array(arguments).concat([!0]));
          },
          doorslide: function(t, i) {
            e.apply(this, H.array(arguments).concat([!1, !0]));
          }
        }
      };
    })();
  A.listen(),
    (t.event.special["click:fast"] = {
      ...
      add: function(i) {
        var n = function(t) {
          ...
          a = { touched: !1, touchdown: !1, coords: { x: 0, y: 0 }, evObj: {} };
        t(this)
          ...
          .on("touchmove.fast", function(e) {
            ...
            Math.max(Math.abs(a.coords.x - i.x), Math.abs(a.coords.y - i.y)) >
              6 && t(this).data("clickstate", t.extend(a, { touchdown: !1 }));
          })
          .on("touchend.fast", function(n) {
            var o = t(this);
            o.data("clickstate").touchdown && i.handler.call(this, n),
              o.data(
                "timer",
          ...
          .on("click.fast", function(e) {
            if (t(this).data("clickstate").touched) return !1;
            t(this).data("clickstate", a), i.handler.call(this, e);
          });
      },
      remove: function() {
    ...
    (i = function() {
      ...
      (this._options = {}),
        ...
        t.each("current total".split(" "), function(t, e) {
      ...
      var l = (this._keyboard = {
          ...
          press: function(t) {
            ...
            e in l.map && "function" == typeof l.map[e] && l.map[e].call(s, t);
          },
          attach: function(t) {
            var e, i;
            for (e in t)
              t.hasOwnProperty(e) &&
                ((i = e.toUpperCase()),
                i in l.keys ? (l.map[l.keys[i]] = t[e]) : (l.map[i] = t[e]));
        ...
        h = (this._carousel = {
          ...
          update: function() {
            ...
            t.each(s._thumbnails, function(a, o) {
              if (o.ready) {
                e += o.outerWidth || t(o.container).outerWidth(!0);
                var r = t(o.container).width();
                (e += r - f.floor(r)),
                  (n[a + 1] = e),
                  (i = f.max(
                    i,
                    o.outerHeight || t(o.container).outerHeight(!0)
                  ));
              }
            }),
              ...
              (h.max = e),
              (h.hooks = n),
              (h.width = s.$("thumbnails-list").width()),
              h.setClasses(),
              s
                .$("thumbnails-container")
                .toggleClass("galleria-carousel", e > h.width),
              (h.width = s.$("thumbnails-list").width());
          },
          ...
          set: function(t) {
            for (t = f.max(t, 0); h.hooks[t - 1] + h.width >= h.max && t >= 0; )
              t--;
          ...
          follow: function(t) {
            ...
            for (
              var e = h.current;
              h.hooks[e] - h.hooks[h.current] < h.width && e <= h.hooks.length;

            )
              e++;
            t - 1 < h.current
              ? h.set(t - 1)
              : t + 2 > e && h.set(t - e + h.current + 2);
          },
          setClasses: function() {
            h.prev.toggleClass("disabled", !h.current),
              h.next.toggleClass(
                "disabled",
                h.hooks[h.current] + h.width >= h.max
              );
          },
          animate: function(e) {
            h.setClasses();
        ...
        d = (this._tooltip = {
          ...
          init: function() {
            ...
            H.insertStyleTag(
              ...
              s
                .$("tooltip")
                .css({ opacity: 0.8, visibility: "visible", display: "none" });
          },
          move: function(t) {
          ...
          bind: function(e, n) {
            if (!i.TOUCH) {
              ...
              var a = function() {
                  s.$("container").off("mousemove", d.move),
                    s.clearTimer(d.timer),
                    s
                      .$("tooltip")
                      .stop()
          ...
          define: function(e, i) {
            ...
            (e = t(e in s._dom ? s.get(e) : e).data("tt", i)), d.show(e);
          }
        }),
        p = (this._fullscreen = {
          scrolled: 0,
          ...
          enter: function(t) {
            p.beforeEnter(function() {
              (t = p.parseCallback(t, !0)),
                s._options.trueFullscreen && A.support
                  ? ((p.active = !0),
                  ...
                  : ((p.scrolled = r.scrollTop()),
                    i.TOUCH || e.scrollTo(0, 0),
                    p._enter(t));
            });
          },
          _enter: function(o) {
            (p.active = !0),
                  ...
                  return (
                    ...
                    r.port != s.port
                      ? (i.raise(
                        ...
                        !1)
                      : ((p.pd = e.parent.document),
                        t(p.pd)
                          .find("iframe")
                          .each(function() {
                            if (
                              (this.contentDocument ||
                                this.contentWindow.document) === a
                            )
                              return (n = this), !1;
                          }),
                        n)
              ...
              b &&
                p.iframe &&
                ((p.iframe.scrolled = t(e.parent).scrollTop()),
                e.parent.scrollTo(0, 0));
            var l = s.getData(),
              c = s._options,
              h = !s._options.trueFullscreen || !A.support,
              u = { height: "100%", overflow: "hidden", margin: 0, padding: 0 };
            if (
              (h &&
                (s.$("container").addClass("fullscreen"),
              ...
              b &&
                p.iframe &&
                (H.forceStyles(p.pd.documentElement, u),
                H.forceStyles(p.pd.body, u),
                H.forceStyles(
                  p.iframe,
                  t.extend(u, {
                    width: "100%",
              ...
              (p.keymap = t.extend({}, s._keyboard.map)),
              s.attachKeyboard({
              ...
              (p.crop = c.imageCrop),
              c.fullscreenCrop != n && (c.imageCrop = c.fullscreenCrop),
            ...
            s.rescale(function() {
              ...
              h ? r.resize(p.scale) : H.show(s.getActiveImage());
          },
          scale: function() {
            s.rescale();
          },
          exit: function(t) {
            p.beforeExit(function() {
              (t = p.parseCallback(t)),
                s._options.trueFullscreen && A.support ? A.exit(t) : p._exit(t);
            });
          },
          _exit: function(t) {
            p.active = !1;
            ...
            if ((p.parent ? p.parent.prepend(a) : a.insertAfter(p.prev), n)) {
              H.hide(s.getActiveImage()),
                H.revertStyles(s.get("container"), _().html, _().body),
                i.TOUCH || e.scrollTo(0, p.scrolled);
              var o = s._controls.frames[s._controls.active];
              o && o.image && (o.image.src = o.image.src);
            }
            b &&
              p.iframe &&
              (H.revertStyles(p.pd.documentElement, p.pd.body, p.iframe),
              p.iframe.scrolled && e.parent.scrollTo(0, p.iframe.scrolled)),
              s.detachKeyboard(),
        ...
        g = (this._idle = {
          ...
          add: function(e, n, a, o) {
            if (e && !i.TOUCH) {
              g.bound || g.addEvent(),
                (e = t(e)),
                "boolean" == typeof a && ((o = a), (a = {})),
                (a = a || {});
              var r,
                s = {};
              for (r in n) n.hasOwnProperty(r) && (s[r] = e.css(r));
              e.data("idle", {
                from: t.extend(s, a),
                to: n,
                complete: !0,
                ...
                o ? e.css(n) : g.addTimer(),
                g.trunk.push(e);
            }
          },
          remove: function(e) {
            (e = t(e)),
              t.each(g.trunk, function(t, i) {
                i &&
                  i.length &&
                  !i.not(e).length &&
                  (e.css(e.data("idle").from), g.trunk.splice(t, 1));
              }),
          ...
          hide: function() {
            if (s._options.idleMode && !1 !== s.getIndex()) {
              ...
              var e = g.trunk.length;
              t.each(g.trunk, function(t, i) {
                var n = i.data("idle");
                n &&
                  ((i.data("idle").complete = !1),
                  H.animate(i, n.to, {
          ...
          showAll: function() {
            s.clearTimer("idle"),
              t.each(g.trunk, function(t, e) {
                g.show(e);
              });
          },
          show: function(e) {
            var n = e.data("idle");
            (g.active && (n.busy || n.complete)) ||
              ((n.busy = !0),
              ...
              H.animate(e, n.from, {
                ...
                complete: function() {
                  (g.active = !0),
                    (t(e).data("idle").busy = !1),
                    (t(e).data("idle").complete = !0);
                }
              })),
              g.addTimer();
          }
        ...
        m = (this._lightbox = {
          ...
          init: function() {
            if (!m.initialized) {
              ...
              (h =
                ...
                (a +=
                  ".galleria-lightbox-box.iframe .galleria-lightbox-prevholder,.galleria-lightbox-box.iframe .galleria-lightbox-nextholder{width:100px;height:100px;top:50%;margin-top:-70px}"),
                H.insertStyleTag(a, "galleria-lightbox"),
                t.each(
                  "overlay box content shadow title info close prevholder prev nextholder next counter image".split(
                    " "
                  ),
                  function(t, i) {
                    s.addElement("lightbox-" + i),
                      (e[i] = m.elems[i] = s.get("lightbox-" + i));
                  }
                ),
                (m.image = new i.Picture()),
                t.each(
                  {
                ...
                s.append(c),
                t(e.image).append(m.image.container),
                t(_().body).append(e.overlay, e.box),
                (function(e) {
                  e.hover(
                    function() {
                  ...
                  t(e.close)
                    .on("click:fast", m.hide)
                    .html("&#215;")
                ),
                t.each(["Prev", "Next"], function(n, a) {
                  var o = t(e[a.toLowerCase()]).html(
                      /v/.test(a) ? "&#8249;&#160;" : "&#160;&#8250;"
                    ),
                    r = t(e[a.toLowerCase() + "holder"]);
                  if (
                ...
                t(e.overlay).on("click:fast", m.hide),
                i.IPAD && (s._options.lightboxTransitionSpeed = 0);
            }
          },
          rescale: function(e) {
            var n = f.min(r.width() - 40, m.width),
              a = f.min(r.height() - 60, m.height),
              o = f.min(n / m.width, a / m.height),
          ...
          hide: function() {
            (m.image.image = null),
              ...
              (m.keymap = !1),
              H.hide(m.elems.overlay, 200, function() {
                t(this)
                  .hide()
          ...
          show: function(n) {
            (m.active = n = "number" == typeof n ? n : s.getIndex() || 0),
            ...
            try {
              for (l = s._options.preload; l > 0; l--)
                (o = new i.Picture()),
                  (a = s.getData(u)),
                  o.preload(a.big ? a.big : a.image),
                  (u = s.getNext(u));
            } catch (t) {}
            (m.image.isIframe = c.iframe && !c.image),
              t(m.elems.box).toggleClass("iframe", m.image.isIframe),
              t(m.image.container)
                .find(".galleria-videoicon")
                .remove(),
              m.image.load(c.big || c.image || c.iframe, function(i) {
                if (i.isIframe) {
                  var a = t(e).width(),
                    o = t(e).height();
                ...
                if (
                  (t(i.image)
                    ...
                    .parent()
                    .height("100%"),
                  (m.elems.title.innerHTML = c.title || ""),
                  (m.elems.counter.innerHTML = n + 1 + " / " + h),
                  r.resize(m.rescale),
                  m.rescale(),
                  c.image && c.iframe)
                ) {
                  if ((t(m.elems.box).addClass("iframe"), c.video)) {
                        ...
                        return function(n) {
                          t(m.image.container)
                            ...
                            i.load(e.iframe + (e.video ? "&autoplay=1" : ""), {
                              width: "100%",
                              height:
                                y < 8 ? t(m.image.container).height() : "100%"
                            });
                        };
                      })(c, i)
                    );
        ...
        v = (this._timer = {
          ...
          add: function(t, i, n, a) {
            if (
              ((t = t || new Date().getTime()), (a = a || !1), this.clear(t), a)
            ) {
              var o = i;
              i = function() {
                o(), v.add(t, i, n);
          ...
          clear: function(t) {
            ...
            if (t && t in this.trunk) n.call(this, t);
            else if (void 0 === t)
              for (i in this.trunk)
                this.trunk.hasOwnProperty(i) && n.call(this, i);
          }
        });
      return this;
    }),
    (i.prototype = {
      ...
      init: function(e, a) {
        if (
          ...
          return void i.raise("Target not found", !0);
        if (
          ((this._options = {
            autoplay: !1,
            carousel: !0,
          ...
          a &&
            (!1 === a.debug && (l = !1),
            "number" == typeof a.imageTimeout && (c = a.imageTimeout),
            "string" == typeof a.dummy && (h = a.dummy),
            "string" == typeof a.theme && (this._options.theme = a.theme)),
          t(this._target)
            .children()
            .hide(),
          i.QUIRK &&
        ...
        return (
          "object" == typeof this.theme ? this._init() : P.push(this), this
        );
      },
      _init: function() {
        var o = this,
        ...
        if (this._initialized)
          return (
            i.raise("Init failed: Gallery instance already initialized."), this
          );
        if (((this._initialized = !0), !this.theme))
          return i.raise("Init failed: No theme found.", !0), this;
        if (
          (t.extend(
            !0,
            s,
          ...
          (s.swipe = (function(t) {
            return (
              "enforced" == t || (!1 !== t && "disabled" != t && !!i.TOUCH)
            );
          })(s.swipe)),
          s.swipe && ((s.clicknext = !1), (s.imagePan = !1)),
          (function(t) {
            if (!("getContext" in t)) return void (t = null);
            $ = $ || {
              elem: t,
          ...
          this.bind(i.DATA, function() {
            e.screen &&
              ...
              this._data.forEach(function(t) {
                ...
                f.max(e.screen.width, e.screen.height) * i < 1024 &&
                  (t.big = t.image);
              }),
          ...
          s.swipe &&
            ...
            (this.finger = new i.Finger(this.get("stage"), {
              ...
              oncomplete: function(e) {
                var i = f.max(0, f.min(parseInt(e, 10), o.getDataLength() - 1)),
                  n = o.getData(i);
              ...
              if (a) {
                ...
                if (a.link)
                  if (o._options.popupLinks) {
                    e.open(a.link, "_blank");
                  } else e.location.href = a.link;
                else;
              }
            }),
            this.bind(i.IMAGE, function(e) {
              o.setCounter(e.index), o.setInfo(e.index);
              var i = this.getNext(),
                n = this.getPrev(),
                a = [n, i];
              a.push(
              ...
              t.each(a, function(e, i) {
                ...
                t.each(r, function(e, i) {
                  ...
                  n.iframe && !n.image && (a.isIframe = !0),
                    a.ready ||
                      o._controls.slides[i].load(r, function(e) {
                        e.isIframe || t(e.image).css("visibility", "hidden"),
                          o._scaleImage(e, {
                            complete: function(e) {
                              e.isIframe ||
                                t(e.image)
          ...
          this.$("image-nav-right, image-nav-left")
            ...
            .on("click", function(t) {
              t.preventDefault(),
                (s.clicknext || s.swipe) && t.stopPropagation();
            }),
          ...
          this.load(),
          s.keepSource || y || (this._target.innerHTML = ""),
        ...
        return (
                  ...
                  function(l) {
                    if (!/(-left|-right)/.test(l.target.className)) {
                      if (
                        ...
                        return o.toggleFullscreen(), void l.preventDefault();
                      (t = r), (n = e), (a = i);
                    }
                  }
                );
          ...
          t.each(i.on.binds, function(e, i) {
            -1 == t.inArray(i.hash, o._binds) && o.bind(i.type, i.callback);
          }),
          this
        );
      },
      addTimer: function() {
        return this._timer.add.apply(this._timer, H.array(arguments)), this;
      },
      clearTimer: function() {
        return this._timer.clear.apply(this._timer, H.array(arguments)), this;
      },
      _getWH: function() {
        var e,
          i = this.$("container"),
        ...
        return (
          t.each(["width", "height"], function(t, r) {
            a._options[r] && "number" == typeof a._options[r]
              ? (o[r] = a._options[r])
              : ((e = [
                  H.parseValue(i.css(r)),
                  H.parseValue(n.css(r)),
                  i[r](),
                  n[r]()
                ]),
                a["_" + r] ||
                  e.splice(
                    ...
                    H.parseValue(n.css("min-" + r))
                  ),
                (o[r] = f.max.apply(f, e)));
          }),
          a._userRatio && (o.height = o.width * a._userRatio),
          o
        );
      },
      _createThumbnails: function(n) {
        ...
        var o,
          ...
          m = (function() {
            ...
            return !!t.length && t.find("img").attr("src");
          })(),
          v =
            "string" == typeof h.thumbnails ? h.thumbnails.toLowerCase() : null,
          _ = function(t) {
          ...
          b = function(e) {
            ...
            c.getIndex() !== i && c.show(i), e.preventDefault();
          },
          w = function(e, n) {
                ...
                t.each(r, function(i, r) {
                  (n = r.toLowerCase()),
                    (!0 === h.thumbCrop && h.thumbCrop !== n) ||
                      ...
                      (a[o[i]] = 0),
                      t(e.image).css(a)),
                    (e["outer" + r] = t(e.container)["outer" + r](!0));
                }),
                  H.toggleQuality(
                    e.image,
                    !0 === h.thumbQuality ||
                      ("auto" === h.thumbQuality &&
                        e.original.width < 3 * e.width)
                  ),
                  h.thumbDisplayOrder && !e.lazy
                    ? t.each(p, function(t, e) {
                        if (t === f && e.ready && !e.displayed)
                          return f++, (e.displayed = !0), void w(e, i);
                      })
                    : w(e, i);
              }
            });
        ...
        for (
          n || ((this._thumbnails = []), this.$("thumbnails").empty());
          this._data[u];
          u++
        )
          (s = this._data[u]),
            (o = s.thumb || s.image),
            (!0 !== h.thumbnails && "lazy" != v) || (!s.thumb && !s.image)
              ? (s.iframe && null !== v) || "empty" === v || "numbers" === v
                ? ((r = {
                  ...
                  "numbers" === v && t(r.image).text(u + 1),
                  s.iframe && t(r.image).addClass("iframe"),
              ...
              : ((r = new i.Picture(u)),
                ...
                "lazy" == v
                  ...
                  : r.load(o, x),
                "all" === h.preload && r.preload(s.image)),
            t(r.container)
              .add(h.keepSource && h.linkSourceImages ? s.original : null)
              .data("index", u)
              .on(h.thumbEventType, b)
              .data("thumbload", x),
            m === o && t(r.container).addClass("active"),
          ...
          t.each(n, function(e, r) {
            if (!(r > a._thumbnails.length - 1)) {
              var s = a._thumbnails[r],
                l = s.data,
                c = function() {
                  ++o == n.length && "function" == typeof i && i.call(a);
                },
      ...
      lazyLoadChunks: function(t, i) {
        var n = this.getDataLength(),
          ...
          l = this;
        for (i = i || 0; a < n; a++)
          s.push(a), (++o != t && a != n - 1) || (r.push(s), (o = 0), (s = []));
        var c = function(t) {
          var n = r.shift();
          n &&
            e.setTimeout(
      ...
      _run: function() {
        ...
        a._createThumbnails(),
          H.wait({
            ...
            until: function() {
              return (
                i.OPERA && a.$("stage").css("display", "inline-block"),
                (a._stageWidth = a.$("stage").width()),
                (a._stageHeight = a.$("stage").height()),
                a._stageWidth && a._stageHeight > 50
              );
            },
            success: function() {
              if ((E.push(a), a._options.swipe)) {
                ...
                t.each(new Array(a.getDataLength()), function(e) {
                  ...
                  t(n.container)
                    ...
                    .prepend(
                      (a._layers[e] = t(H.create("galleria-layer")).css({
                        position: "absolute",
                        top: 0,
                        left: 0,
                        right: 0,
              ...
              if (
                ...
                return (
                  a._options.autoplay && a.trigger(i.PLAY),
                  void (
                    "number" == typeof a._options.show &&
              ...
              (a._firstrun = !0),
                i.History &&
                  i.History.change(function(t) {
                    isNaN(t) ? e.history.go(-1) : a.show(t, n, !0);
                  }),
                a.trigger(i.READY),
                a.theme.init.call(a, a._options),
                t.each(i.ready.callbacks, function(t, e) {
                  "function" == typeof e && e.call(a, a._options);
                }),
                a._options.extend.call(a, a._options),
                /^[0-9]{1,4}$/.test(d) && i.History
                  ? a.show(d, n, !0)
                  : a._data[a._options.show] && a.show(a._options.show),
                a._options.autoplay && a.trigger(i.PLAY);
            },
            error: function() {
              i.raise(
              ...
              t(e)
                ...
                .each(function(e, i) {
                  ...
                  var n = {},
                    ...
                    s = r.attr("href"),
                    l = r.attr("rel");
                  s && ("IMG" == i[0].nodeName || i.hasClass("video")) && S(s)
                    ? (n.video = s)
                    : s && i.hasClass("iframe")
                    ? (n.iframe = s)
                    : (n.image = n.big = s),
                    ...
                    t.each(
                      ...
                      function(t, e) {
                        i.data(e) && (n[e] = i.data(e).toString());
                      }
                    ),
                    n.big || (n.big = n.image),
                    o._data.push(
      ...
      _parseData: function(e) {
        var i,
          ...
          r = function() {
            var i = !0;
            t.each(a._data, function(t, e) {
              if (e.loading) return (i = !1), !1;
            }),
              i && !o && ((o = !0), e.call(a));
          };
        return (
              ...
              s &&
                ((i.iframe =
                  ...
                  (function() {
                    if ("object" == typeof a._options[s.provider]) {
                      var e = [];
                      return (
                        t.each(a._options[s.provider], function(t, i) {
                          e.push(t + "=" + i);
                        }),
                        "youtube" == s.provider &&
                          (e = ["wmode=opaque"].concat(e)),
                        "?" + e.join("&")
                      );
                    }
                    return "";
                ...
                (i.thumb && i.image) ||
                  t.each(["thumb", "image"], function(t, e) {
                    if ("image" == e && !a._options.videoPoster)
                      return void (i.image = n);
      ...
      push: function() {
        var t = this,
          i = H.array(arguments);
        return (
          1 == i.length && i[0].constructor == Array && (i = i[0]),
          e.setTimeout(function() {
      ...
      bind: function(t, e) {
        return (t = k(t)), this.$("container").on(t, this.proxy(e)), this;
      },
      unbind: function(t) {
        return (t = k(t)), this.$("container").off(t), this;
      },
      trigger: function(e) {
        return (
          (e =
      ...
      addIdleState: function(t, e, i, n) {
        return this._idle.add.apply(this._idle, H.array(arguments)), this;
      },
      removeIdleState: function(t) {
        return this._idle.remove.apply(this._idle, H.array(arguments)), this;
      },
      ...
      enterFullscreen: function(t) {
        return this._fullscreen.enter.apply(this, H.array(arguments)), this;
      },
      exitFullscreen: function(t) {
        return this._fullscreen.exit.apply(this, H.array(arguments)), this;
      },
      ...
      bindTooltip: function(t, e) {
        return (
          this._tooltip.bind.apply(this._tooltip, H.array(arguments)), this
        );
      },
      defineTooltip: function(t, e) {
        return (
          this._tooltip.define.apply(this._tooltip, H.array(arguments)), this
        );
      },
      refreshTooltip: function(t) {
        return (
          this._tooltip.show.apply(this._tooltip, H.array(arguments)), this
        );
      },
      openLightbox: function() {
        return (
          this._lightbox.show.apply(this._lightbox, H.array(arguments)), this
        );
      },
      closeLightbox: function() {
        return (
          this._lightbox.hide.apply(this._lightbox, H.array(arguments)), this
        );
      },
      ...
      addPan: function(e) {
        if (!1 !== this._options.imageCrop) {
          ...
          var i = this,
            ...
            g = 0,
            m = function(t, i, n) {
              if (t > 0 && ((g = f.round(f.max(-1 * t, f.min(0, i)))), p !== g))
                if (((p = g), 8 === y)) e.parent()["scroll" + n](-1 * g);
                else {
                  var a = {};
                  (a[n.toLowerCase()] = g), e.css(a);
                }
            },
            v = function(t) {
              H.timestamp() - d < 50 ||
          ...
          return (
            ...
            this.$("stage")
              .off("mousemove", v)
              .on("mousemove", v),
            this.addTimer("pan" + i._id, _, 50, !0),
            this
          );
        }
      },
      ...
      attachKeyboard: function(t) {
        return (
          this._keyboard.attach.apply(this._keyboard, H.array(arguments)), this
        );
      },
      detachKeyboard: function() {
        return (
          this._keyboard.detach.apply(this._keyboard, H.array(arguments)), this
        );
      },
      ...
      remove: function(t) {
        return this.$(H.array(arguments).join(",")).remove(), this;
      },
      append: function(t) {
        var e, i;
        for (e in t)
          ...
          var n,
            a = function(e) {
              t(e.container)
                .children(":first")
                .css({
                  top: f.max(0, H.parseValue(e.image.style.top)),
                  left: f.max(0, H.parseValue(e.image.style.left)),
          ...
          function() {
            (r._stageWidth = e || r.$("stage").width()),
              ...
              r._options.swipe
                ...
                : r._scaleImage(),
              r._options.carousel && r.updateCarousel(),
              r._controls.frames[r._controls.active] &&
        ...
        if (this._options.preload) {
          ...
          try {
            for (e = this._options.preload; e > 0; e--)
              (t = new i.Picture()),
                (n = this.getData(a)),
                t.preload(this.isFullscreen() && n.big ? n.big : n.image),
                (a = this.getNext(a));
          } catch (t) {}
        }
      },
      show: function(n, a, o) {
        ...
        if (
          ...
          if (
            ((n = f.max(0, f.min(parseInt(n, 10), this.getDataLength() - 1))),
            (a = void 0 !== a ? !!a : n < this.getIndex()),
            !(o = o || !1) && i.History)
          )
            return void i.History.set(n.toString());
          if (
            (this.finger &&
              n !== this._active &&
            ...
            this.trigger(t.extend(g, { type: i.LOADSTART })),
              c.$("container").removeClass("videoplay");
            var m = function() {
              (c._layers[n].innerHTML = c.getData().layer || ""),
                c.trigger(t.extend(g, { type: i.LOADFINISH })),
                c._playCheck();
            };
            c._preload(),
              e.setTimeout(function() {
                u.ready && t(u.image).attr("src") == h
                  ? (c.trigger(t.extend(g, { type: i.IMAGE })), m())
                  : (l.iframe && !l.image && (u.isIframe = !0),
                    u.load(h, function(e) {
                      (g.imageTarget = e.image),
                        c
                          ._scaleImage(e, m)
                          .trigger(t.extend(g, { type: i.IMAGE })),
                        m();
                    }));
              }, 100);
          } else
        ...
        if (r) {
            ...
            return function() {
              ...
              (M.active = !1),
                ...
                t(r.container)
                  ...
                  .show(),
                a._controls.swap(),
                a._options.imagePan && a.addPan(r.image),
                ((o.iframe && o.image) ||
                  o.link ||
                  a._options.lightbox ||
                    ...
                    .on("mouseup", function(r) {
                      if (!("number" == typeof r.which && r.which > 1)) {
                        if (o.iframe) {
                          ...
                          return (
                            t(s.container)
                              .css({ width: l, height: c, opacity: 0 })
                              .show()
                              .animate({ opacity: 1 }, 200),
                            void e.setTimeout(function() {
                              s.load(
                                o.iframe + (o.video ? "&autoplay=1" : ""),
                                { width: l, height: c },
                                function(t) {
                        ...
                        return a._options.clicknext && !i.TOUCH
                          ? (a._options.pauseOnInteraction && a.pause(),
                            void a.next())
                          : o.link
                          ? void (a._options.popupLinks
                              ? (u = e.open(o.link, "_blank"))
                              : (e.location.href = o.link))
                          : void (a._options.lightbox && a.openLightbox());
                      }
                    }),
                a._playCheck(),
                a.trigger({
          ...
          this._options.carousel &&
            ...
            h.load(l, function(e) {
              ...
              a._scaleImage(e, {
                complete: function(e) {
                  "image" in c && H.toggleQuality(c.image, !1),
                    H.toggleQuality(e.image, !1),
                    a.removePan(),
                    a.setInfo(o.index),
                  ...
                  if (
                    (t.each(
                      ...
                      function(t, e) {
                        if (e && a._options[t + "Transition"] !== n)
                          return (l = a._options[t + "Transition"]), !1;
                      }
                    ),
                    l in M.effects == !1)
                  )
                    ...
                    (M.active = !0), M.init.call(a, l, h, f);
                  }
                  a.trigger({
                    type: i.LOADFINISH,
                    cached: u,
      ...
      getNext: function(t) {
        return (
          (t = "number" == typeof t ? t : this.getIndex()),
          t === this.getDataLength() - 1 ? 0 : t + 1
        );
      },
      getPrev: function(t) {
        return (
          (t = "number" == typeof t ? t : this.getIndex()),
          0 === t ? this.getDataLength() - 1 : t - 1
        );
      },
      next: function() {
      ...
      _playCheck: function() {
        ...
        if (this._playing) {
          this.clearTimer(a);
          var o = function() {
            if ((e = H.timestamp() - n) >= t._playtime && t._playing)
              return t.clearTimer(a), void t.next();
            t._playing &&
              (t.trigger({
                type: i.PROGRESS,
                percent: f.ceil((e / t._playtime) * 100),
                seconds: f.floor(e / 1e3),
                milliseconds: e
              }),
              t.addTimer(a, o, 20));
          };
      ...
      hasInfo: function(t) {
        var e,
          i = "title description".split(" ");
        for (e = 0; i[e]; e++) if (this.getData(t)[i[e]]) return !0;
        return !1;
      },
      jQuery: function(e) {
        var i = this,
    ...
    t.extend(i, {
      ...
      TOUCH: "ontouchstart" in a && v
    }),
    (i.addTheme = function(n) {
      n.name || i.raise("No theme name specified"),
        (!n.version || parseInt(10 * i.version) > parseInt(10 * n.version)) &&
          i.raise(
            "This version of Galleria requires " +
              n.name +
              " theme version " +
              parseInt(10 * i.version) / 10 +
              " or later",
            !0
          ),
        "object" != typeof n.defaults
          ? (n.defaults = {})
      ...
      return (
        "string" == typeof n.css
          ? (t("link").each(function(t, e) {
              if (((a = new RegExp(n.css)), a.test(e.href)))
                return (r = !0), F(n), !1;
            }),
            r ||
              t(function() {
                  ...
                  l = function() {
                    t("script").each(function(t, i) {
                      (a = new RegExp(
                        ...
                        (a.test(i.src) || o.test(i.src)) &&
                          ((r = i.src.replace(/[^\/]*$/, "") + n.css),
                          e.setTimeout(function() {
                            H.loadCSS(
                              r,
    ...
    (i.get = function(t) {
      return D[t]
        ...
        : "number" != typeof t
        ? D
        : void i.raise("Gallery index " + t + " not found");
    }),
    (i.configure = function(e, n) {
      var a = {};
      return (
        "string" == typeof e && n ? ((a[e] = n), (e = a)) : t.extend(a, e),
    ...
    (i.raise = function(e, i) {
      ...
      if (l) {
        if ((o(e), i)) throw new Error(n + ": " + e);
      } else if (i) {
        if (L) return;
        (L = !0), (i = !1), o("Gallery could not load.");
      }
    }),
    (i.version = 1.57),
    ...
    (i.Picture.prototype = {
      ...
      load: function(n, a, o) {
        if (("function" == typeof a && ((o = a), (a = null)), this.isIframe)) {
        ...
        (this.image = new Image()),
          i.IE8 && t(this.image).css("filter", "inherit"),
          i.IE ||
            i.CHROME ||
            i.SAFARI ||
      ...
      scale: function(e) {
        ...
        if (
          ...
          var o,
            ...
            l = e.height;
          if (e.iframelimit) {
            var c = f.min(e.iframelimit / s, e.iframelimit / l);
            c < 1
              ? ((o = s * c),
                (r = l * c),
                t(this.image).css({
        ...
        return (
          H.wait({
            until: function() {
              return (
                (h = e.width || p.width() || H.parseValue(p.css("width"))),
                (u = e.height || p.height() || H.parseValue(p.css("height"))),
                h && u
              );
            },
            success: function() {
              var i = (h - 2 * e.margin) / a.original.width,
                n = (u - 2 * e.margin) / a.original.height,
                o = f.min(i, n),
                r = f.max(i, n),
                s = {
                  true: r,
                ...
                l = s[e.crop.toString()],
                c = "";
              e.max && (l = f.min(e.max, l)),
                e.min && (l = f.max(e.min, l)),
                t.each(["width", "height"], function(e, i) {
                  t(a.image)[i](
                    (a[i] = a.image[i] = f.round(a.original[i] * l))
                  );
                }),
                t(a.container)
                  .width(h)
              ...
              t.each(e.position.toLowerCase().split(" "), function(t, e) {
                "center" === e && (e = "50%"), (p[t ? "top" : "left"] = e);
              }),
                t.each(p, function(e, i) {
                  v.hasOwnProperty(i) && t.extend(g, v[i]);
                }),
                (p = p.top ? t.extend(p, g) : g),
                (p = t.extend({ top: "50%", left: "50%" }, p)),
                t(a.image).css({
                  position: "absolute",
                  top: m(p.top, "height", u),
      ...
      var n = (f.abs,
        (i.HAS3D = (function() {
          var e,
            ...
            r = 0,
            s = "transform";
          for (_().html.insertBefore(n, null); o[r]; r++)
            (i = o[r] ? o[r] + "Transform" : s),
              void 0 !== n.style[i] &&
                ((n.style[i] = "translate3d(1px,1px,1px)"),
                (e = t(n).css(o[r] ? "-" + o[r].toLowerCase() + "-" + s : s)));
          return (
            _().html.removeChild(n),
        ...
        s = function(i, a) {
          if (
            ...
            t.extend(this.config, a),
              ...
              (this.setX = function() {
                var t = o.child.style;
                if (!n) return void (t.left = o.pos + "px");
                t.MozTransform = t.webkitTransform = t.transform =
                  "translate3d(" + o.pos + "px,0,0)";
              }),
        ...
        (s.prototype = {
          ...
          setup: function() {
            (this.width = t(this.elem).width()),
              (this.length = f.ceil(t(this.child).width() / this.width)),
              0 !== this.index &&
          ...
          ontouchmove: function(t) {
            ...
            (e && e.length > 1) ||
              ...
              null === this.isScrolling &&
                (this.isScrolling = !!(
                  this.isScrolling ||
                  f.abs(this.deltaX) < f.abs(e[0].pageY - this.start.pageY)
                )),
              this.isScrolling ||
                (t.preventDefault(),
                (this.deltaX /=
          ...
          moveTo: function(t) {
            t != this.index &&
              ((this.pos = this.to = -t * this.width), (this.index = t));
          },
          loop: function() {
            ...
            if (
              (this.width &&
                t &&
                (e = f.max(0.5, f.min(1.5, f.abs(t / this.width)))),
              this.touching || f.abs(t) <= 1)
            )
              (this.pos = this.to),
                (t = 0),
                this.anim &&
              ...
              var i = +new Date() - this.anim.time,
                n = this.config.duration * this.anim.factor;
