    ...
    Galleria.addTheme({
        ...
        init: function(b) {
            ...
            var a = this,
                ...
                o = !1,
                p = function() {
                    n.height(a.getStageHeight())
                        .width(a.getStageWidth())
                        .css("top", d ? 0 : a.getStageHeight() + 30);
                },
                q = function() {
                    d && o ? a.play() : ((o = g), a.pause());
                    Galleria.utils.animate(
                        n, { top: d ? a.getStageHeight() + 30 : 0 }, {
                            easing: "galleria",
                            duration: 400,
                            complete: function() {
                                a.defineTooltip(
                                    "thumblink",
                                    d ? c.show_thumbnails : c.hide_thumbnails
                                );
            ...
            b._showTooltip &&
                a.bindTooltip({
                    ...
                    counter: function() {
                        return c.showing_image
                            .replace(/\%s/, a.getIndex() + 1)
            ...
            b._showProgress &&
                this.bind("progress", function(a) {
                    l.width((a.percent / 100) * this.getStageWidth());
                });
            ...
            this.bind("fullscreen_enter", function() {
                m = !0;
                a.setOptions("transition", !1);
                f.addClass("open");
                h.css("bottom", 0);
                this.defineTooltip("fullscreen", c.exit_fullscreen);
                Galleria.TOUCH || this.addIdleState(h, { bottom: -31 });
            });
            this.bind("fullscreen_exit", function() {
                ...
                f.removeClass("open");
                h.css("bottom", 0);
                this.defineTooltip("fullscreen", c.enter_fullscreen);
                Galleria.TOUCH || this.removeIdleState(h, { bottom: -31 });
            });
            this.bind("rescale", p);
            Galleria.TOUCH ||
            ...
            b._showPopout ?
                ...
                (k.remove(),
                    ...
                    (this.$("s4").remove(),
                        ...
                        f.css("right", 0)));
            j.click(function() {
                a.defineTooltip("play", g ? c.play : c.pause);
                g ? a.pause() : (d && i.click(), a.play());
            });
            b._showFullscreen ?
                f.click(function() {
